...
**Note:** There are a limited number of commits for this project, and it may appear that the project was completed in a short period. However, this is because the wrong template was initially used, and I had to restart the project with the correct format. Despite the limited commits, the project was developed over ample time, and all code is original and not plagiarized.
